...
@section('content')
    ...
    <div class="row g-4 mb-4">
        @foreach ([
            'Starting Capital' => [$capitalSummary['starting_capital'], false], 'Current Capital' => [$capitalSummary['current_capital'], false], 'Net P&L' => [$capitalSummary['net_pnl'], true], 'Return' => [$capitalSummary['return_percent'], 'percent'],
            'Total Allocated' => [$capitalSummary['total_allocated_capital'], false], 'Total Gross P&L' => [$capitalSummary['total_gross_pnl'], true], 'Total Fees' => [$capitalSummary['total_fees'], false], 'Canonical Net P&L' => [$capitalSummary['total_canonical_net_pnl'], true],
            'Max Drawdown' => [$capitalSummary['max_drawdown']['amount'], false], 'Max Drawdown %' => [$capitalSummary['max_drawdown']['percent'], 'percent'],
    ...
    <div class="card metric-card mb-4"><div class="card-body p-0">
        <div class="p-3"><h2 class="h5 mb-0">Win/Loss Summary</h2></div>
