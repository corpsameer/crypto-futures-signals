...
@section('content')
    ...
    <div class="card metric-card mb-4"><div class="card-body p-0"><div class="p-3"><h2 class="h5 mb-1">Capital Progression</h2><p class="small text-muted mb-0">Analytical capital applies stored net P&amp;L for wins, subtracts invested capital when a loss has no stored negative P&amp;L, and leaves open/skipped rows at zero change.</p></div>
