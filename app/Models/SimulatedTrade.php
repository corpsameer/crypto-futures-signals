...
class SimulatedTrade extends Model
{
    ...
    protected $casts = [
        ...
        'max_price_after_entry' => 'decimal:12',
        'min_price_after_entry' => 'decimal:12',
        ...
        'max_actual_gain_percent' => 'decimal:4',
        'max_actual_loss_percent' => 'decimal:4',
        'max_gain_percent' => 'decimal:4',
        'max_loss_percent' => 'decimal:4',
